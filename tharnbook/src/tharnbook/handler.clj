(ns tharnbook.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [tharnbook.routes.home :refer [home-routes]]
            [tharnbook.middleware :as middleware]
            [tharnbook.session :as session]
            [tharnbook.db.core :as db]
...
(defn init
  ...
  (timbre/info (str
                 "\n-=[tharnbook started successfully"
...
(defn destroy
  ...
  []
  (timbre/info "tharnbook is shutting down...")
  (stop-nrepl)
  (db/disconnect!)
