(ns tharnstr.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [tharnstr.routes.home :refer [home-routes]]
            [tharnstr.middleware :as middleware]
            [tharnstr.session :as session]
...
(defn destroy
  ...
  []
  (timbre/info "tharnstr is shutting down...")
  (stop-nrepl)
